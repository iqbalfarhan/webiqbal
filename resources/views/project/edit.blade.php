...
<div class="box box-primary">
	...
	<form action="{{ route('project.update', $data) }}" method="POST" enctype="multipart/form-data">
		@csrf
		@method('PUT')
		<div class="box-body">
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="file" class="form-control @error('photo') is-invalid @enderror" id="photo" name="photo" value="{{ $data->photo }}" accept="image/png, image/jpeg">
						@if($errors->has('photo'))
				...
				<div class="col-md-8">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control @error('client') is-invalid @enderror" id="client" name="client" value="{{ $data->client }}">
					...
					<div class="form-group">
						...
						<textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="5">{{ $data->keterangan }}</textarea>
					...
					<div class="checkbox">
						<label class="form-control-label" for="show">
							<input type="checkbox" class="@error('show') is-invalid @enderror" id="show" name="show" {{ $data->show ? "checked" : '' }} placeholder="">
							Show project
						</label>
						@if($errors->has('show'))
